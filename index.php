		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Hotel <span>Taj</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Address :</strong>Hotel Taj Mumbai</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>Designed for mini <a href="index.php">project</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
